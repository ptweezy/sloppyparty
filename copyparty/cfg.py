...
flagcats = {
    ...
    "thumbnails": {
        ...
        "vc_maxh=720": "max height of transcoded video (0=source)",
        "vc_vq=23": "h264 quality (crf) for transcoded video; lower=better",
        "vc_preset=veryfast": "x264 speed/efficiency preset",
        "vc_aq=128": "audio bitrate (kbps) for transcoded video",
        "vc_seg=4": "HLS segment duration in seconds",
    },
